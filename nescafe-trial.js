(function() {
    ...
    function injectStyles() {
        ...
        style.textContent = `
            ...
            .expand-button { position: absolute; width: 200px; height: 200px; top: 100%; left: 100%; transform: translate(-100%, -100%) translate3d(-60px, -70px, 0px); }
            .close-button { position: absolute; width: 120px; height: 48px; background-color: rgba(153, 153, 153, 0.2); top: 0; opacity: 0; left: 100%; transform: translate(-100%, 0%); }
            .gwd-image-kyh7 { position: absolute; width: 200px; height: 200px; top: 100%; left: 100%; transform: translate(-100%, -100%) translate3d(-60px, -70px, 0px) scale3d(0.001, 0.001, 1); }
            .gwd-image-16ed { position: absolute; width: 200px; height: 200px; left: 100%; top: 100%; transform: translate(-100%, -100%) translate3d(-50px, 190px, 0px) rotateZ(50deg); }
            ...
            .gwd-image-1tz2 { position: absolute; width: 16px; height: 16px; left: 100%; top: 0; transform: translate(-100%, 0%) translate3d(-20px, 20px, 0px); }
        `;
